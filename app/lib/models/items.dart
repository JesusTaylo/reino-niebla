...
const List<GearItem> gearCatalog = [
  ...
  GearItem(
    id: 'pluma_anselmo',
    name: 'Pluma de Anselmo',
    desc: 'Todavía tiene tinta. Todavía pesa como un reino.',
    slot: GearSlot.reliquia,
    rarity: Rarity.epico,
    colorA: Color(0xFFF0E6D2),
    colorB: Color(0xFF2C2137),
    variant: 8,
  ),
  GearItem(
    id: 'martillo_ram',
    name: 'Martillo de Ram',
    desc: 'Dos golpes, pausa, dos golpes. Hay ritmos que la Niebla no sabe comer.',
    slot: GearSlot.reliquia,
    rarity: Rarity.legendario,
    colorA: Color(0xFF8C9BA5),
    colorB: Color(0xFF6E4F2F),
    variant: 6,
  ),
  GearItem(
    id: 'silbato_himmel',
    name: 'Silbato de Himmel',
    desc: 'Tres notas: bajita-alta-media. Un pájaro de esos que ya no hay.',
    slot: GearSlot.reliquia,
    rarity: Rarity.legendario,
    colorA: Color(0xFFB08D57),
    colorB: Color(0xFF3E6B4A),
    variant: 7,
  ),
  GearItem(
    id: 'brujula_celeste',
